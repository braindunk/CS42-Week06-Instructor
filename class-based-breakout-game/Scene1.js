...
class Scene1 extends Phaser.Scene {
  ...
  create() {
    ...
    // instead of let ball outside the curlies, and the ball = inside the curlies
    // with class-based coding I save the same data in a property of the class object instance
  ...
  // all custom code for events become part of the scene
  hitPaddle() {
